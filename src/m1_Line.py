...
class Line(object):
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        line3_start = Point(self.start.x + other_line.start.x, self.start.y + other_line.start.y)
        line3_end = Point(self.end.x + other_line.end.x, self.end.y + other_line.end.y)
        line3 = Line(line3_start, line3_end)
        return line3
